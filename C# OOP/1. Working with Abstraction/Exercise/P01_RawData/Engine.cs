...
namespace P01_RawData
{
    public class Engine
    {
        ...
        public void Run() // ще вика нужните класове, за да не се случва това в main
        {
        ...
        private Car CreateCar(string[] parameters)
        {
            ...
            Car car = new Car(model, engineSpeed, enginePower, cargoWeight, cargoType, firstTire, secondTire,
                thirdTire, fourthTire);
